         ...
         stage('Checkout') {
             steps {
                 script {
                     ...
                     dir('INT_API-CI') {
                         deleteDir()
                         checkout([$class: 'GitSCM', branches: [[name: 'gadi']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'GadiGamburg_GIT', url: "https://github.com/gadigamburg/INT_API.git"]]])
